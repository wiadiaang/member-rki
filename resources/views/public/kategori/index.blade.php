...
<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">kategori - List
                </h1>
                ...
                <div class="card card-flush">
                    ...
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                            ...
                            <a href="{{ route('kategori.create') }}" class="btn btn-sm btn-light-primary">
                        ...
                        <!--end::Svg Icon-->Add New kategori</a>
...
var KTDataTable = function() {
    ...
    return {
        init: function() {
            ...
            (t = document.querySelector("#kategori_table")) && (t.querySelectorAll(
                    "tbody tr").forEach((t => {
                    ...
                    columns: [{"data":"DT_RowIndex","name":"DT_RowIndex","orderable":false,"searchable":false},{"data":"kategori","name":"kategori"},{"data":"action","name":"action"}]

                }),
                (() => {
                    const e = "List kategori";
